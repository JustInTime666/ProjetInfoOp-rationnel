...
%plus basses, mais elles considérait l'ensemble d'éléments à insérer comme un seul et unique.
  ...
  %retourne la partition prise en argument avec comme durée totale Secondes (en sec.)
   ...
   fun {Duration Secondes Partition} % /!\ doit retourner un liste qu'on va append!!!!
	 ...
	 elseif {Int.is Secondes} then %cas supposé ne pas arriver dans les consignes
	 ...
	 if Somme == Secondes then Partition
	    ...
	    {stretch Facteur Partition}%etape5, on retourne une liste modifiée.
	 end
      end
   end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %-------------------------------------------------------------------------------
	    ...
	    %Musi est une partition tel que {Music} en recoit.Je considère que {Music} ne renvoie bien qu'une liste!
   %retourne alors une liste d'échantillons
   fun{Reverse Music}
      local
	 fun {Rev List Acc}
 ...
 %-------------------------------------------------------------------------------
   ...
   %répète Amout fois la musique Music si Amount=1 alors music n'est jouée que une fois-------------------------------------------------------------------------- Just t'es d'accord?
   %retourne des echantillons, échantillonner tout en premier temps permet de faire appel à {Music} 1 fois contre Amount fois pour la même Music
 ...
 %-------------------------------------------------------------------------------
	    ...
	    % répete Musi tant que Seconds de sample n'est pas atteint.
